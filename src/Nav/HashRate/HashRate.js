...
// import HashTurnCoin from './component/HashTurnCoin';
...
export default class HashRate extends React.Component {
    ...
    renderList () {
        let list = [];
        let array = [
            {title: this.state.language.app_Operate_HashRate_title_left, img: require('../../Image/rightImage.png'), component: 'HashTurnCoin'},
            {title: this.state.language.app_Operate_HashRate_title_right, img: require('../../Image/rightImage.png'), component: 'HashRecord'},
        ];
        array.forEach((v, i) => {
            list.push(
