...
import {
    ...
    View,
    StyleSheet,
    ScrollView, InteractionManager, AsyncStorage, ToastAndroid, TouchableOpacity, Image, Animated
} from 'react-native';
import Utils from "../../../Components/Utils";
import {Loading} from "../../../Components/Loading";

export default class HashRecord extends React.Component {
    ...
    async loadData () {
        try {
            ...
            let data = await Utils.postJSON(Utils.size.url + '/v1/contract/getProfit', formData);
            console.log(data);
                ...
                list.push(
                    <View style={styles.RecordList} key={i}>
                        <View style={styles.RecordCard}>
                            ...
                            <Text style={styles.RecordCardMain}>{v.repeat_code}</Text>
