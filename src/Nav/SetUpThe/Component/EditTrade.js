...
import {
    ...
    Image,
    TouchableOpacity,
    Animated, TextInput, ScrollView, AsyncStorage, InteractionManager, ToastAndroid,
} from 'react-native';
import Utils from "../../../Components/Utils";
import {TextInputLayout} from 'rn-textinputlayout';
import {Loading} from "../../../Components/Loading";
export default class EditTrade extends React.Component {
                ...
                <View style={[styles.content, styles.aboutUsMainList]}>
                    <ScrollView>
                        <View style={styles.NewMoneyMain}>
                            ...
                            <Text style={{color: '#fff', fontSize: 10, paddingTop: 10}}>{this.state.language.app_EditTrade_text}</Text>
    ...
    async AsyncOnEditPwd () {
        try {
            ...
            let data = await Utils.postJSON(Utils.size.url + '/v1/contract/editTrade', formData);
            console.log(data);
            if (Number(data.code) === 0) {
                Loading.hidden();
