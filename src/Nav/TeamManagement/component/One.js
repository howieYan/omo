                ...
                <View style={styles.mainTable}>
                    <View style={styles.table}>
                        <View style={styles.tableWidth}>
                            <Text numberOfLines={1} style={[styles.tableTitle, styles.tableTitleWight]}>{this.state.language.app_Team_one_account}</Text>
                        </View>
                        <View style={styles.tableWidth}>
                            <Text numberOfLines={1} style={[styles.tableTitle, styles.tableTitleWight]}>{this.state.language.app_Team_one_real_name}</Text>
                        </View>
                        <View style={styles.tableWidth}>
                            <Text numberOfLines={1} style={[styles.tableTitle, styles.tableTitleWight]}>{this.state.language.app_Team_one_phone}</Text>
                        </View>
                        <View style={styles.tableWidth}>
                            <Text numberOfLines={1} style={[styles.tableTitle, styles.tableTitleWight]}>{this.state.language.app_Team_one_name}</Text>
                        </View>
                    </View>
                    <ScrollView>
